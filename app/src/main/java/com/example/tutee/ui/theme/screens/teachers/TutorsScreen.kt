...
import com.example.tutee.models.Product
import com.example.tutee.ui.theme.TUTEETheme

@Composable
fun ViewTutorScreen(navController: NavHostController) {
...
@Composable
fun StudyItem(name:String, profession:String, price:String, id:String,
...
fun ViewTutorsScreenPreview(){
    TUTEETheme {
        ViewTutorScreen(navController = rememberNavController())
    }
}