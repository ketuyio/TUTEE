package com.example.tutee.data
...
class AuthView(var navController: NavHostController, var context: Context) {
    ...
    fun signup(name:String, email:String, password:String){
        ...
        mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener {
            ...
            var userProfile = com.example.tutee.models.User(name, email, password, userId)
